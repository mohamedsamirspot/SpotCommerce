    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            foreach(var list in detailCart.listCart)
            {
                ...
                detailCart.OrderHeader.OrderTotal = detailCart.OrderHeader.OrderTotal + (list.Item.Price * list.Count);
        ...
        public async Task<IActionResult> SummaryPost(string stripeToken)
        {
            ...
            {
                item.Item = await _db.Item.FirstOrDefaultAsync(m => m.Id == item.MenuItemId);
            ...
            if (charge.Status.ToLower() == "succeeded")
            {
                ...
                await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == claim.Value).FirstOrDefault().Email, "SpotCommerce - Order Created With id: " + detailCart.OrderHeader.Id.ToString(), "Order has been submitted Successfully");
