...
namespace SpotCommerce.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        [Authorize(Roles = SD.OperatorUser + "," + SD.ManagerUser)]
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "SpotCommerce - Order Ready for Pickup " + orderHeader.Id.ToString(), "Order is ready for pickup.");
        ...
        public async Task<IActionResult> OrderCancel(int OrderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "SpotCommerce - Order Cancelled " + orderHeader.Id.ToString(), "Order has been cancelled successfully.");
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "SpotCommerce - Order Completed " + orderHeader.Id.ToString(), "Order has been completed successfully.");
